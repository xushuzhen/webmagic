...
//        }
    ...
    public static void main(String args[]){
        LoginWeibo login = new LoginWeibo();
        String getgsid = login.loginAndGetGsid("15210631912","xsz6134597");
        CookieStore getcookie = login.loginAndGetCookie("15210631912","xsz6134597");
        System.out.println(getgsid);
